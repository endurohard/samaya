...
import { pool } from './db';
import { listCalls, listEmployees, type VatsCall } from './vats';
      ...
      await client.query(
        `INSERT INTO telephony.calls
           (id, company_id, started_at, direction, client_number, client_digits,
            client_name_vats, line, extension, duration_sec, status, has_recording, synced_at)
         VALUES ($1, $2, $3::timestamptz, $4, $5, $6, $7, $8, $9, $10, $11, $12, NOW())
